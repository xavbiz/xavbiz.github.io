      ...
      <Section noTopMargin>
        <Grid col="1">
          <Grid.Item col="1">
              ...
              <Paragraph>Xavier Richard and Pierre Saint-Arroman set up <strong>Amazon Caribbean Guyana Ltd</strong> in 1986, having <strong>built 3 canning factories</strong> for the processing of manicole palms and pineapple in Region 1,2 and 5. Since then, the company has been taken over by <strong>local entrepreneurs who have further expanded</strong>, providing revenue to thousands of households.</Paragraph>
              <Paragraph>Xavier Guy Richard leads due diligences on behalf of Swiss institutions which invest into agroforestry projects in Africa (Mango, Moringa, Pecan nuts trees), Brazil (Bactris, Acai palm trees), Suriname (Cherry and Moringa trees), French Guyana, Peru and Nicaragua (Cocoa and Coffee trees).</Paragraph>
              ...
              <Paragraph><Quote>Hundreds of such projects can blossom in Guyana through an innovative financing mechanism.</Quote></Paragraph>
